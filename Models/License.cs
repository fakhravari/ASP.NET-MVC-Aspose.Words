...
namespace LicenseHelper
{
    public class License
    {
        ...
        public static Stream LStreamAsposeKey = (Stream)new MemoryStream(Convert.FromBase64String(AsposeKey));
        public static Stream LStreamCellAsposeKey = (Stream)new MemoryStream(Convert.FromBase64String(AsposeKey));

        public const string DocumentUltimateKey = "QEPPRF-YREWFA-7DTPUN-3PBJV4-VA2A1F-Q1C6G4-HAPW27-KXK4FU-7YDVWC-JR7BGF-52KCXJ-FVVJUL-NNA";
        public static string LDocumentUltimateKey = LicenseHelper.License.DocumentUltimateKey;
